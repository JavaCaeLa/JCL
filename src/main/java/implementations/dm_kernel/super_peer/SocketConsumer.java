...
public class SocketConsumer<S extends JCL_handler> extends GenericConsumer<S> {
	...
	public SocketConsumer(GenericResource<S> re, AtomicBoolean kill, commom.JCL_connector routerLink,ConcurrentMap<String, Map<String, String>> slaves,String superpeerID) {
...
//					if (verbose)
//						System.err.println(
//								msg.getType() + " - " + "getResultBlocking(id) - " + formatador.format(calendar.getTime()));
//
...
//
//							// Write data
//							super.WriteObjectOnSock(msgResult, str,false);
//							// End Write data
//						} else {
//														
//							// config msg
...
//				case 7: {
//					System.err.println(
//							msg.getType() + " - " + "getResultUnblocking(id) - " + formatador.format(calendar.getTime()));
//
//					JCL_message_long jclC = (JCL_message_long) msg;
//					long id = jclC.getRegisterData()[0];
//					Object[] hostPortTicket = this.taskLocation.get(id);
...
//
//					// Write data
//					super.WriteObjectOnSock(mr, str,false);
//					// End Write data
//
//					break;
//				}
